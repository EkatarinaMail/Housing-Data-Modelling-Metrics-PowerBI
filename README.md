...
This project builds on the cleaned dataset created in Project 1 (Линк в git hub можно поставить на project1?) by developing a complete analytical solution in Power BI. The main goal was to design a reliable data model, create business KPIs using DAX, and present the results in an interactive dashboard for a UK housing association.
